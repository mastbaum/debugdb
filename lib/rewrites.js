...
module.exports = [
    ...
    // tags
    {from: '/tags', to: '_list/tag_list/tags_with_status'},
    {from: '/tags/:id', to: '_show/tags/:id'},
    {from: '/tag', to: '_list/tags/tags_by_board'},
    ...
    // crate
    {from: '/crater/:id', to: '_list/crater/crater', query: {
        startkey: [':id'],
        endkey: [':id', {}]
    }},
