...
exports.final_test = function (head, req) {
    ...
    var content = templates.render("final_test.html", req, {
        ...
        pass: doc.pass,
        created: doc.created,
        fec_comments: doc.fec_comments, 
        cleaned: doc.cleaned,
        refurbished: doc.refurbished,
        dc_offset_n100: doc.dc_offset_n100,
        dc_offset_n20: doc.dc_offset_n20,
        dc_offset_esumlo: doc.dc_offset_esumlo,
        dc_offset_esumhi: doc.dc_offset_esumhi,
        db0_comments: doc.db0_comments,
        db0_dark_matter: doc.db0_dark_matter,
        db1_comments: doc.db1_comments,
        db1_dark_matter: doc.db1_dark_matter,
        db2_comments: doc.db2_comments,
        db2_dark_matter: doc.db2_dark_matter,
        db3_comments: doc.db3_comments,
        db3_dark_matter: doc.db3_dark_matter,
        tests: tests
    });
