...
//        document.title = 'AAA Final Test Updated';
//        return [doc, content];
//    }

//    else {

        return [doc, templates.render('base.html', req, {
            content: content,
...
exports.test_delete = function(doc, req) {
    ...
    */
    return [doc, utils.redirect(req, '/tests/' + doc.type)];
};
...
exports.test_archive = function(doc, req) {
    ...
    */
    return [doc, utils.redirect({}, '/')]; // + doc.type + '/' + doc._id)];
};
